...
Al inicio, el Hornocal se presenta con una escala de 1,07 en escritorio y 1,01 en móvil, desplazado 2,5 % hacia abajo. A lo largo de una altura del hero se reduce a 0,92 y 0,88 respectivamente. El plano intermedio parte 32 % más abajo y el frente 42 % más abajo; ambos suben mientras el fondo se aleja. Al final, la compensación vertical de fondo, plano intermedio y frente es +48 %, +14 % y +4 % en escritorio; +34 %, +10 % y +3,5 % en móvil. La entrada usa únicamente `transform` sobre las mismas tres imágenes.
